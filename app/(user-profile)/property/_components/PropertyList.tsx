...
export function PropertyList() {
  ...
  return (
    <div className="space-y-6 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h4 className="text-xl sm:text-2xl font-semibold text-[#0F3D61]">Property</h4>
          <h3 className="text-xs sm:text-sm text-[#929292] mt-1">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 !mb-6 sm:!mb-10">
        <div className="text-sm sm:text-base text-[#929292] truncate">
          Dashboard <span className="mx-1 sm:mx-2">{">"}</span> Apartment Listings Management
        </div>
        <Link href="/add-property">
          <Button className="bg-[#0F3D61] hover:bg-[#0F3D61]/90 h-[50px] text-sm sm:text-base rounded-[8px] text-[#F4F4F4]">
        ...
        <div className="w-full overflow-x-auto">
          <table className="w-full min-w-[600px] text-sm sm:text-base">
            <thead className="border-b border-[#B6B6B6] bg-gray-50">
              <tr>
                <th className="px-3 sm:px-6 py-3 text-left font-bold text-[#131313] uppercase tracking-wider whitespace-nowrap">
                  Day Or Event
                </th>
                <th className="px-3 sm:px-6 py-3 text-left font-bold text-[#131313] uppercase tracking-wider whitespace-nowrap">
                  Apartment Name
            ...
            <tbody className="divide-y divide-[#B6B6B6] bg-white">
              {currentData.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  <td className="px-3 sm:px-6 py-3 whitespace-nowrap text-[#424242]">{item.day}</td>
                  <td className="px-3 sm:px-6 py-3 whitespace-nowrap text-[#424242]">{item.name}</td>
                  <td className="px-3 sm:px-6 py-3 whitespace-nowrap text-[#424242]">
                    {item.date}
                    <br />
