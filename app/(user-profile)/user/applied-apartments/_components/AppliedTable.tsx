...
//     switch (status) {
//       case "approved":
//         return <Badge className="bg-green-500 hover:bg-green-600 text-center h-8 p-0 w-20 flex justify-center  ">Approved</Badge>
//       case "denied":
//         return <Badge className="bg-red-500 w-20 text-center hover:bg-red-600 p-0 h-8 flex justify-center  ">Denied</Badge>
//       case "pending":
//       default:
//         return <Badge className="bg-yellow-500 w-20  hover:bg-yellow-600 flex justify-center  h-8">Pending</Badge>
//     }
//   }
...
//                   <TableCell className="py-8 px-5">
//                     <Image
//                       src={app.apartmentId.images?.[0] ?? '/default-image.jpg'}
//                       alt={app.apartmentId?.title}
//                       width={100}
//                       height={100}
...
//                         {app.apartmentId?.bedrooms}BR / {app.apartmentId?.bathrooms}BA
//                       </div>
//                     </div>
//                   </TableCell>
//                   <TableCell className="font-medium">${app.apartmentId?.price}</TableCell>
//                   <TableCell className="font-medium">{app.employmentInfo?.employerName}</TableCell>
//                   <TableCell className="text-sm">{app.employmentInfo?.jobTitle}</TableCell>
