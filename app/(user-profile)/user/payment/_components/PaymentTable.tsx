...
//                                         <span
//                                             className={` py-3  px-10 rounded-[8px] text-white ${item.status === "approved"
//                                                     ? "bg-green-600"
...
//                                         <button className="bg-[#0F3D61]  text-white px-4 py-2 rounded-[8px] text-base base:text-base hover:bg-[#0c314f]">
//                                             Pay
//                                         </button>
//                                     </td>
//                                 </tr>
