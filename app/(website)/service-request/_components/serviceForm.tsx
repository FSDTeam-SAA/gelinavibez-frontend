...
export default function ServiceForm() {
  ...
  return (
    <div className="container mx-auto ">
      <h1 className="text-[#0F3D61] font-bold text-[40px] mt-[120px] text-center md:text-left">
      ...
      <Form {...form}>
        ...
        >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        className="border py-[25px] placeholder:text-gray-400 border-[#C0C3C1] rounded-[5px]"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <select
                        className="border border-[#C0C3C1] rounded-[5px] bg-white w-full h-[51px] px-3 text-gray-700"
                        {...field}
                      >
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            <div className="col-span-12 md:col-span-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[16px] font-semibold text-[#424242]">Contact Info for Access</FormLabel>
                    <FormControl>
                      <Input
                        className="border py-[25px] placeholder:text-gray-400 border-[#C0C3C1] rounded-[5px]"
                        placeholder="e.g. Concierge, buzzer #123"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage className="text-red-500" />
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <FormControl>
                          ...
                          >
                            {field.value ? format(field.value, "PPP") : "Pick today's date"}
                            <CalendarIcon className="ml-auto h-4 w-4 opacity-50" />
                          </Button>
                        </FormControl>
                      </PopoverTrigger>
          ...
          <FormField
            ...
            name="checkbox"
            render={({ field }) => (
              <FormItem className="flex flex-row items-center space-x-3 space-y-0 rounded-md  p-4 bg-white">
                <FormControl>
                  <Checkbox
                    checked={field.value}
                ...
                <div className="space-y-1 leading-none">
                  <FormLabel className="text-sm font-normal text-[#616161]">
                    By signing below, I authorize Bridge Point Solutions LLC to share my information with a licensed extermination company for service coordination. I understand Bridge Point Solutions is a referral intermediary and not the direct service provider.
                  </FormLabel>
                  <FormMessage className="text-red-500" />
                </div>
              </FormItem>
          ...
          <div className="flex justify-end w-full pt-8">
            <Button
              ...
              className="bg-[#0F3D61] hover:bg-[#0F3D61]/90 text-white px-12 py-6 rounded-[5px] font-semibold text-lg transition-all flex items-center gap-3"
            >
