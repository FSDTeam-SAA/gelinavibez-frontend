...
//   pestProblem: z.string().min(1),
//   locationOfProblem: z.string().min(1),
//   durationOfIssue: z.string().min(1),
//   exterminationService: z.string().min(1),
//   preferredServiceDate: z.coerce.date(),
//   preferredTime: z.string().min(1),
//   building: z.string().min(1),
//   contactInfo: z.string().min(1),
//   signature: z.string().min(1),
//   date: z.coerce.date(),
//   checkbox: z.boolean().refine(val => val === true, "You must agree before submitting")
// })
...
//         className="space-y-8 max-w-4xl mx-auto py-10 px-4"
//       >
//         {/* Full Name & Phone */}
