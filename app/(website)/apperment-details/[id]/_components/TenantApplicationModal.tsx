...
const inputClasses = "h-[48px] rounded-[4px] border-[#C0C3C1] placeholder:text-[#6C757D]"
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-8 pb-10">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input name="firstName" placeholder="Saurav" required className={inputClasses} />
                </div>
                <div className="space-y-2">
                  <Label className="text-base text-[#424242] font-semibold">Last Name *</Label>
                  <Input name="lastName" placeholder="Sarkar" required className={inputClasses} />
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input name="phone" type="tel" placeholder="+880123456789" required className={inputClasses} />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Input name="rentalCity" placeholder="Dhaka" className={inputClasses} />
                </div>
                <div className="space-y-2">
                  <Label className="text-base text-[#424242] font-semibold">State</Label>
                  <Input name="rentalState" placeholder="Dhaka" className={inputClasses} />
                </div>
                <div className="space-y-2">
                  <Label className="text-base text-[#424242] font-semibold">Zip</Label>
                  <Input name="rentalZip" placeholder="1207" className={inputClasses} />
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label className="text-base text-[#424242] font-semibold">Landlord Name</Label>
                  <Input name="landlordName" placeholder="Rahim Uddin" className={inputClasses} />
                </div>
                <div className="space-y-2">
                  <Label className="text-base text-[#424242] font-semibold">Landlord Number</Label>
                  <Input name="landlordNumber" placeholder="+8801987654321" className={inputClasses} />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input name="employerName" placeholder="Tech Company Ltd" className={inputClasses} />
                </div>
                <div className="space-y-2">
                  <Label className="text-base text-[#424242] font-semibold">Job Title</Label>
                  <Input name="jobTitle" placeholder="Software Engineer" className={inputClasses} />
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label className="text-base text-[#424242] font-semibold">Monthly Income</Label>
                  <Input name="monthlyIncome" type="number" placeholder="5000" className={inputClasses} />
                </div>
                <div className="space-y-2">
                  <Label className="text-base text-[#424242] font-semibold">Employer Address</Label>
                  <Input name="employerAddress" placeholder="45/B, Tech Park" className={inputClasses} />
                </div>
              </div>
              <div className="space-y-2">
                <Label className="text-base text-[#424242] font-semibold">Source of Income</Label>
                <Input name="sourceOfIncome" placeholder="Salary" className={inputClasses} />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label className="text-base text-[#424242] font-semibold">City</Label>
                  <Input name="appliedCity" placeholder="Dhaka" required className={inputClasses} />
                </div>
                <div className="space-y-2">
                  <Label className="text-base text-[#424242] font-semibold">State</Label>
                  <Input name="appliedState" placeholder="Dhaka" required className={inputClasses} />
                </div>
              </div>
              <div className="space-y-2">
                <Label className="text-base text-[#424242] font-semibold">Zip</Label>
              ...
              <div className="space-y-3">
                ...
                <RadioGroup value={hasVoucher} onValueChange={setHasVoucher} className="flex gap-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="voucher-yes" className="text-sm font-normal cursor-pointer">Yes</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="no" id="voucher-no" />
                    <Label htmlFor="voucher-no" className="text-sm font-normal cursor-pointer">No</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div className="space-y-3">
                ...
                <RadioGroup value={livesInShelter} onValueChange={setLivesInShelter} className="flex gap-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="shelter-yes" className="text-sm font-normal cursor-pointer">Yes</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="no" id="shelter-no" />
                    <Label htmlFor="shelter-no" className="text-sm font-normal cursor-pointer">No</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div className="space-y-3">
                ...
                <RadioGroup value={affiliatedWithHomebase} onValueChange={setAffiliatedWithHomebase} className="flex gap-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="homebase-yes" className="text-sm font-normal cursor-pointer">Yes</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="no" id="homebase-no" />
                    <Label htmlFor="homebase-no" className="text-sm font-normal cursor-pointer">No</Label>
                  </div>
                </RadioGroup>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {[
                  { label: "Upload ID *", id: "idFile", file: idFile, setFile: setIdFile, name: "idCard", required: true },
                  { label: "Upload SSN *", id: "ssnFile", file: ssnFile, setFile: setSsnFile, name: "ssnDoc", required: true },
                  { label: "Upload Voucher", id: "voucherFile", file: voucherFile, setFile: setVoucherFile, name: "voucherDoc", required: hasVoucher === "yes" },
                  { label: "Upload Income *", id: "incomeFile", file: incomeFile, setFile: setIncomeFile, name: "incomeDoc", required: true },
            ...
            {hasVoucher === "yes" && (
              <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="space-y-2">
                  ...
                  <Input name="programType" placeholder="Housing Assistance" className={inputClasses} />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label className="text-base text-[#424242] font-semibold">Caseworker Name</Label>
                    <Input name="caseworkerName" placeholder="Jamal Uddin" className={inputClasses} />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-base text-[#424242] font-semibold">Caseworker Email</Label>
                    <Input name="caseworkerEmail" type="email" placeholder="jamal@example.com" className={inputClasses} />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label className="text-base text-[#424242] font-semibold">Caseworker Number</Label>
                  <Input name="caseworkerNumber" placeholder="+8801777888999" className={inputClasses} />
                </div>
              </div>
            )}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input name="signature" placeholder="Type your full name" required className={inputClasses} />
                </div>
                <div className="space-y-2">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-2">
                ...
                <label htmlFor="consent" className="text-base text-[#616161] leading-relaxed cursor-pointer">
                  By submitting, a non-refundable fee of{" "}
