    ...
    <div className="min-h-screen flex items-center justify-center bg-[white]/40 relative overflow-hidden">
      ...
      <div className="relative z-10 bg-white rounded-[8px] shadow-2xl p-8 max-w-md w-full mx-4">
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          {/* Heading */}
          <h1 className="text-2xl font-bold text-slate-900">Your Stripe Account has been created</h1>

          {/* Subtext */}
          <p className="text-slate-600 text-sm">Your Stripe Account has been created successfully!</p>
