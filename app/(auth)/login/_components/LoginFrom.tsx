...
//                     className="bg-transparent border-[#C0C3C1]  placeholder:text-white/40 pl-5 focus:border-white/40 h-12 rounded-full pr-12 text-[#F9F6F1]"
//                     required
//                   />
//                   <button
//                     type="button"
...
export default function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const loadingToastId = toast.loading("Logging you in…", { duration: Infinity });
    ...
    try {
      ...
      toast.success("Login successful!", { id: loadingToastId, duration: 2000 });
      ...
      toast.error("Something went wrong. " + err?.message, { id: loadingToastId });
    } finally {
      setLoading(false);
    }
  };
    ...
    <>
      ...
      <AuthLayout>
        <div className="w-full max-w-[624px]">
          <div className="bg-[#FFFFFF1A]/10 border border-white/10 p-8 md:p-10 rounded-[6px]">
            <div className="mb-10">
              <h1 className="font-serif text-4xl md:text-5xl font-normal text-[#C5A574] mb-2">Hello!</h1>
              <h3 className="text-[#F9F6F1] text-base font-normal">Access to manage your account</h3>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="email" className="text-[#F5F5F5] text-base font-medium">Email *</Label>
                <Input
                  id="email"
                  type="email"
                  placeholder="Enter your email..."
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="text-[#F5F5F5] text-base font-medium">Password *</Label>
                <div className="relative">
                  <Input
                    id="password"
                    type={showPassword ? "text" : "password"}
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm text-[#D4AF7A] hover:text-[#E5C08B] transition-colors">Forget Password?</Link>
              </div>
            ...
            <div className="mt-8 text-center text-sm text-white/80">
              Don&apos;t have an account?{" "}
              <Link href="/signup" className="text-white font-medium hover:text-[#D4AF7A] transition-colors">Sign Up</Link>
            </div>
          </div>
        </div>
      </AuthLayout>
