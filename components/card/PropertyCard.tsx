  ...
  return (
    <div className="rounded-[12px] overflow-hidden shadow-lg hover:shadow-xl transition-shadow bg-white">
      ...
      <div className="p-4 sm:p-5 md:p-6">
        ...
        {/* Property Stats */}
        <div className="flex justify-between flex-wrap items-center gap-4 sm:gap-6 mb-6 text-[#666666]">
...
// import { TenantApplicationModal } from "@/app/(website)/apperment-details/[id]/_components/TenantApplicationModal";
...
//       toast.error("Only tenants can apply.", {
//         duration: 4000,
...
//               variant="outline"
//               className="border-[#0F3D61] text-[#0F3D61] hover:bg-[#0F3D61] hover:text-white transition-colors text-sm font-medium"
//             >
//               Apply Now
//             </Button>
//           </div>
