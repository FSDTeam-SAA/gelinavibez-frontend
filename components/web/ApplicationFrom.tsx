...
export function TenantApplicationModal({
  ...
  const [agreement3Accepted, setAgreement3Accepted] = useState(false);

  const [agreement1Sig, setAgreement1Sig] = useState("");
  const [agreement2Sig, setAgreement2Sig] = useState("");
  const [agreement3Sig, setAgreement3Sig] = useState("");
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      voucher: hasVoucher === "yes"
        ? { hasVoucher: true, type: voucherType }
        : { hasVoucher: false },
      ...
      housingSpecialist: hasVoucher === "yes"
        ? {
            ...
            phone: get("housingSpecialistNumber"),
          }
        : undefined,
      ...
      agreements: {
        agreement1: {
          accepted: agreement1Accepted,
          signature: agreement1Sig.trim(),
        },
        agreement2: {
          accepted: agreement2Accepted,
          signature: agreement2Sig.trim(),
        },
        agreement3: {
          accepted: agreement3Accepted,
          signature: agreement3Sig.trim(),
        },
      },
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="pets-yes" className="text-sm font-normal cursor-pointer">
                      Yes
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="no" id="pets-no" />
                    <Label htmlFor="pets-no" className="text-sm font-normal cursor-pointer">
                      No
                    </Label>
                  </div>
                </RadioGroup>
              ...
              {hasVoucher === "yes" && (
                <div className="space-y-4 p-4 bg-gray-50 rounded-[4px]">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label className="text-base text-[#424242] font-semibold">
                        Housing Specialist Email
                      </Label>
                      <Input
                        name="housingSpecialistEmail"
                        type="email"
                  ...
                  <div className="space-y-2">
                    <Label className="text-base text-[#424242] font-semibold">
                      Housing Specialist Number
                    </Label>
                    <Input
                      name="housingSpecialistNumber"
                      placeholder="+8801777888999"
                      className={inputClasses}
                    />
                  </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  <Checkbox
                    id="agreement1"
                    checked={agreement1Accepted}
                    onCheckedChange={(v) => setAgreement1Accepted(!!v)}
                  />
                  <label
                    htmlFor="agreement1"
                    className="text-base text-[#616161] leading-relaxed cursor-pointer"
                  >
                    Agreement 1: I certify that the information provided is true and accurate to the best of my knowledge.
                  </label>
                </div>
                {agreement1Accepted && (
                  <div className="pl-8 space-y-2">
                    ...
                    <Input
                      value={agreement1Sig}
                      onChange={(e) => setAgreement1Sig(e.target.value)}
                      placeholder="Type your full name"
                      className={inputClasses}
                    />
                  </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  <Checkbox
                    id="agreement2"
                    checked={agreement2Accepted}
                    onCheckedChange={(v) => setAgreement2Accepted(!!v)}
                  />
                  <label
                    htmlFor="agreement2"
                    className="text-base text-[#616161] leading-relaxed cursor-pointer"
                  >
                    Agreement 2: I authorize verification of all information, references, and credit history.
                  </label>
                </div>
                {agreement2Accepted && (
                  <div className="pl-8 space-y-2">
                    ...
                    <Input
                      value={agreement2Sig}
                      onChange={(e) => setAgreement2Sig(e.target.value)}
                      placeholder="Type your full name"
                      className={inputClasses}
                    />
                  </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  <Checkbox
                    id="agreement3"
                    checked={agreement3Accepted}
                    onCheckedChange={(v) => setAgreement3Accepted(!!v)}
                  />
                  <label
                    htmlFor="agreement3"
                    className="text-base text-[#616161] leading-relaxed cursor-pointer"
                  >
                    Agreement 3: I understand that submission of this application does not guarantee approval or a lease.
                  </label>
                </div>
                {agreement3Accepted && (
                  <div className="pl-8 space-y-2">
                    ...
                    <Input
                      value={agreement3Sig}
                      onChange={(e) => setAgreement3Sig(e.target.value)}
                      placeholder="Type your full name"
                      className={inputClasses}
                    />
                  </div>
